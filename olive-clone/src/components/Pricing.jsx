  ...
  return (
    <section className="py-24 bg-white px-4">
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#1F3824] mb-12 text-center tracking-tight">
          Healthy Choices<br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
          ...
          <div className="rounded-3xl p-8 border border-gray-200 bg-white shadow-sm flex flex-col">
          ...
          <div className="rounded-3xl p-8  bg-[#386641] text-white shadow-xl flex flex-col relative overflow-hidden">
